<div class="bg-white p-6 rounded-lg ">
    <form wire:submit="save" class="space-y-4">
        ...
        <div>
            ...
            <select id="project_id" wire:model="project_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
        ...
        <div>
            ...
            <input type="date" id="due_date" wire:model="due_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
